...
export const Projects = () => {
  const projects = [
    {
      ...
      description: "C#, SQL",
      imgUrl: bdd,
      git: "https://github.com/atinyshrimp/BDD-Projet-BelleFleur",
      link: "",
      ...
      article: `
            <div class='modal-header'>
                ...
                <div class='link-icons'>
                    <a href="https://github.com/atinyshrimp/BDD-Projet-BelleFleur" target="_blank" id="github">
                        <img src=${github} />
                    </a>
                </div>
            </div>
    ...
    },
    {
      ...
      description: "C#",
      imgUrl: img_app,
      git: "https://github.com/atinyshrimp/Image-processing-tool",
      link: "",
      article_enabled: true,
      article: `
            <div class='modal-header'>
                ...
                <div class='link-icons'>
                    <a href="https://github.com/atinyshrimp/Image-processing-tool" target="_blank" id="github">
                        <img src=${github} />
                    </a>
                </div>
            </div>
    ...
    },
    {
      ...
      imgUrl: prison_break,
      git: "",
      link: "https://docs.google.com/presentation/d/1YWvVbmrZWhavDnhxS9y3T_4clyqmkN1sWIg8_cJuokQ/edit?usp=sharing",
      article_enabled: true,
      article: `
            <div class='modal-header'>
                <div class='basic-info'>
  ...
  const schoolProjects = [
    {
      ...
      imgUrl: api_proj,
      git: "https://github.com/atinyshrimp/Data-Analysis-Project",
      link: "",
      article_enabled: true,
      article: `
                <div class='modal-header'>
                ...
                <div class='link-icons'>
                    <a href="https://github.com/atinyshrimp/Data-Analysis-Project" target="_blank" id="github">
                        <img src=${github} />
                    </a>
                </div>
            </div>
  ...
  const games = [
    ...
    // },
    {
      ...
      article: `
            <div class='modal-header'>
                ...
                <div class='link-icons'>
                    <a href="https://github.com/atinyshrimp/Programmer-Theory-Repo" target="_blank" id="github">
                        <img src=${github} />
                    </a>
    ...
    },
    {
      ...
      git: "",
      link: "https://atinyshrimp.itch.io/color-pool",
      article_enabled: true,
      article: `
            <div class='modal-header'>
                <div class='basic-info'>
                    <a href="https://atinyshrimp.itch.io/" target="_blank">    
                        <img src=${itchio} />
                    </a>
                    <h4>Color Pool</h4>
                </div>
                <div class='link-icons'>
                    <a href="https://atinyshrimp.itch.io/color-pool" target="_blank">
                        <img src=${extLink} />
                    </a>
                </div>
            </div>
