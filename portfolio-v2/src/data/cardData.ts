...
export const cards: Card[] = [
  // Project Cards
  {
    ...
    links: [
      ...
      { label: "Live Demo", url: "https://joycelapilus.com/portfolio-v2" },
    ],
    isFeatured: true,
    projectDetails: {
      duration: "4 weeks",
  ...
  },
  {
    ...
    links: [{ label: "GitHub", url: "https://github.com/username/ecommerce" }],
    projectDetails: {
      duration: "3 months",
  ...
  // Experience Cards
  {
    ...
    tags: ["Leadership", "Frontend", "Team Management"],
    experienceDetails: {
      company: "Selego",
...
export const decks = [
  ...
  },
  {
    ...
    description: "The complete overview of my skills, projects and experience",
