            ...
            <ProfileContainer>
                ...
                <div>
                            ...
                            <DeckPreview key={deck.id}>
                                <div className="deck-info">
                                    ...
                                    <div className="deck-stats">
                                        {deck.cards} cards • {deck.winRate} win
                                        rate
                                    </div>
                                </div>
                                <Link
                    ...
                    <ProfileCard style={{ marginTop: "var(--spacing-md)" }}>
                        ...
                        >
                            <p>
                                • Won a match with "Mystic Dragons" deck (3
                                hours ago)
                            </p>
                            <p>• Added 5 new cards to collection (yesterday)</p>
                            <p>
                                • Created new deck "Elemental Mages" (2 days
                                ago)
                            </p>
                            <p>
                                • Unlocked "Strategist" achievement (3 days ago)
                            </p>
